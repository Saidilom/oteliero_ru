    ...
    <Link href={`/rooms/${room.id}?${urlSearchParamsString}`} target="_blank">
      <div className="searchRoomItem">
        ...
        <div className="details">
          <div className="title">
            <h1 style={{}}>{room.title}</h1>
          </div>
          <div className="location">{room.address}</div>
...
function ViewDetails() {
  return <div className="viewDetailsBtn">View Details</div>;
}

function BookNow() {
  return <div className="bookNowBtn">Book Now</div>;
}
